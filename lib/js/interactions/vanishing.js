$(document).ready(function () {
	...
	Vanishing.prototype.getEndpoint = function(distance, selected) {
	...
	Vanishing.prototype.dev = function(segX, segY) {
		...
		this.getEndpoint(50, "one");
		this.getEndpoint(50, "two");
		this.getEndpoint(50, "three")
	}
