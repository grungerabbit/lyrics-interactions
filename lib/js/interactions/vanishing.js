						...
						for (var u = 0; u < numScanlines; u++) {
							...
							*/				
							...
							if (orientation === "horizontal") {
								...
								var b = firstLine.first.yCoord - (self.slope * firstLine.first.xCoord)
								
								console.log((firstLine.adjust - b) / self.slope)
								
					
							
								
								function test(segment, selected) {
									
									var color = color ? color : "red";
								
									var vertexX = (segment.adjust - b) / self.slope;
								...
								test(firstLine, "three")
								test(firstLine, "three")
								test(firstLine, "three")
								test(firstLine, "three")
								
								self.edge(self.gc(firstSeg[1].xCoord, firstLine.adjust), self.gc(secondSeg[1].xCoord, secondLine.adjust))
