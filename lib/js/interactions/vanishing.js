(function($) {
	var VP = {
		...
		"init" : function () {
			...
			Vanishing.prototype.dev = function(segX, segY, width, height, depth) {
				// seed
				this.guideSeg(segX, segY);
		
				// width
				this.getNearVertex(width, "two", "magenta");
				// height
				this.getNearVertex(height, "three", "cyan");
				// depth
				this.getNearVertex(depth, "one", "yellow");
			...
			var seed2 = new Vanishing(points);
