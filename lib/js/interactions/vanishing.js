							...
							*/				
							...
							if (orientation === "horizontal") {
								...
								function adjustXvalues(segment, place) {
									...
									b = segment.first.yCoord - (self.slope * segment.first.xCoord)
								
									// TODO: why isn't this perfect 100%?
								...
								self.edge(self.gc(adjustXvalues(firstLine, "first"), firstLine.adjust), self.gc(adjustXvalues(secondLine, "second"), secondLine.adjust))
