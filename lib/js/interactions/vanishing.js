...
vanish.controller('vanishingSettings', function vanishingSettings ($scope) {
	...
	// TODO: make into select control
	$scope.presets = [
		{
			"name": "Test", 
			"dataset": $scope.testCube 
		}, 
		{
			"name": "Giant",
			"dataset": $scope.giantOnly
		}, 
		{
			"name": "Empire",
			"dataset": $scope.empire
		}, 
		{
			"name": "Polyhedra",
			"dataset": $scope.polyhedra
		}
	];
	...
	$scope.dataset = $scope.empire;
	
	var paper = new Raphael(0, 0, 2000, 4000);
	
	
	$scope.redraw = function() {
		paper.remove();
		paper = new Raphael(0, 0, 2000, 4000);
	...
	var VP = {
		...
		"makePolyhedron" : function (settings, paper) {
			...
			var Vanishing = function(settings) {
				this.vpX1 = $scope.points.vpX1;
				this.vpY1 = $scope.points.vpY1;
				this.vpX2 = $scope.points.vpX2;
				this.vpY2 = $scope.points.vpY2;
				this.vpX3 = $scope.points.vpX3;
				this.vpY3 = $scope.points.vpY3;
