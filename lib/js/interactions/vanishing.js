$(document).ready(function () {
	...
	Vanishing.prototype.getMidVertex = function(vpoint1, vertex1, vpoint2, vertex2) {
	...
	Vanishing.prototype.dev = function(segX, segY) {
		...
		this.getMidVertex("one", 2, "two", 1);
		this.getMidVertex("one", 3, "three", 1);
		this.getMidVertex("two", 3, "three", 2);
	}
